...
type (
	MenuModel interface {
		...
		GetMenuList(in *system.MenuListReq) ([]*Menu, int64, error)
		UpdateMenu(id int64, menu *Menu) error
		DeleteMenuByIds(ids []int64) error
		GetMenusByUserID(userID int64) ([]system.MenuListData, error)
	}
...
func (m *defaultMenuModel) GetMenuList(in *system.MenuListReq) ([]*Menu, int64, error) {
	var list []*Menu
...
func (m *defaultMenuModel) GetMenusByUserID(userID int64) ([]system.MenuListData, error) {
